...
if (!function_exists('employee_profile_photo')) {
    /**
     * Generate patient profile photo URL (support S3 or local).
     */
    function employee_profile_photo(string $photo): string
    {
        $base = rtrim(config('module-employee.filesystem.profile_photo'), '/');
